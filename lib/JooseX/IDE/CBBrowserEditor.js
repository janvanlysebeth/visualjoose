Class("JooseX.IDE.CBBrowserEditor", {
    ...
    has: {
        ...
        titleEditor: {is: 'rw'},
        bodyEditor: {is: 'rw'},
        isInitialized: {is: 'ro', init:function() {return false}}
    },
    ...
    methods: {
        ...
        selectTitleAndGiveFocus: function() {
            var l1 = this.getTitleEditor().firstLine();
            return this.getTitleEditor().selectLines(
                l1, 0, l1, this.getTitleEditor().lineContent(l1).length);
        }
