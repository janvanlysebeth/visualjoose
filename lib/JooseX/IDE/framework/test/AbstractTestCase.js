Class("JooseX.IDE.framework.test.AbstractTestCase", {
    ...
    methods: {
        ...
        assertOpen: function(anApplicationModelClass, onReadyCallback) {
            var self = this;
            return anApplicationModelClass.open(this.monitor(onReadyCallback),
                function(anError) {
                    self.__failure.call(self, anError);
                });
        },
...
Class("JooseX.IDE.TestTool", {
    ...
    methods: {
        initializeInWindow: function(aBrowserWindow, onReadyCallback) {
