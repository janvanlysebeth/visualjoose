...
Class("JooseX.IDE.VJ", {
    ...
    methods: {
        bind: function() {            
            this.__delegateToJQeuryEventAPI('bind', arguments);
        },
        
        unbind: function() {
            this.__delegateToJQeuryEventAPI('unbind', arguments);
        },
        
        trigger: function(eventType, extraEventData) {
            var event = $.Event(eventType);
            event.extraEventData = extraEventData;
            this.__delegateToJQeuryEventAPI('trigger', [event]);
        },
        
        __delegateToJQeuryEventAPI: function(functionName, arguments) {            
            var jqueryWrappedGlobalDocument = $(this.__globalDocument());
            jqueryWrappedGlobalDocument[functionName].apply(jqueryWrappedGlobalDocument, arguments);
        },
        ...
        openApplicationModel: function(anApplicationModel, onReadyCallback, onFailureCallback) {
            ...
            aChildWindow.onload = function() {
                anApplicationModel.initializeInWindow(aChildWindow, onReadyCallback);
            };  
        },
        
        __globalDocument: function() {
