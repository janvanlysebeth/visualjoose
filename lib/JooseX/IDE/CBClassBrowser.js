Class("JooseX.IDE.CBClassBrowser", {
        ...
        getAllModules: function() {
            ...
            function flattenNameSpaceTree(aNamespace) {
                try {
                    ...
                    /* swallow securaty exceptions in firefox which are thrown
    ...
    my: {
        methods: {
            ...
            openInNewChildWindowOf: function(aWindow) {
                var aChildWindow = aWindow.open("http://localhost:8080/ide/class_browser_stripped.html");
                var inst = new JooseX.IDE.CBClassBrowser();
